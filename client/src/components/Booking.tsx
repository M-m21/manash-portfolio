        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-16 text-center">
            ...
            <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
              Let's discuss your project, collaboration opportunity, or any questions you might have
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Quick discussion about your project or inquiry",
              },
              {
                icon: Clock,
                title: "1-Hour Meeting",
                description: "In-depth discussion and collaboration planning",
              },
              {
                icon: MapPin,
                title: "Custom Meeting",
                description: "Tailored meeting for specific needs",
              },
            ].map((option) => {
          ...
          <motion.div variants={itemVariants} className="text-center">
            <Card className="p-12 bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20 inline-block">
              ...
              <p className="text-foreground/80 mb-8 max-w-md">
                Choose a time that works best for you. I'm available for calls, meetings, and collaborations.
              </p>
              <Button
                size="lg"
          ...
          {/* Availability Info */}
          <motion.div variants={itemVariants} className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            {[
              {
                label: "Timezone",
              ...
              <Card key={info.label} className="p-6 bg-card border-border/50 text-center">
